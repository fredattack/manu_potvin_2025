    ...
    <header class="header-three header--sticky">
        <div class="container">
            <div class="row header-top-three">
                <div class="col-lg-6">
                    <p class="top-left">Are you ready to grow up your business? <a href="{{ route('contactPage') }}">Contact
                            Us <i class="far fa-arrow-right"></i></a></p>
                </div>
                                ...
                                <div class="col-12">
                                    <div class="banner-three-inner">
                                        ...
                                        <div class="button-group">
                                            <a href="{{ route('pricePlans') }}" class="rts-btn btn-primary-3">Get
                                                Started</a>
                                            <a href="{{ route('aboutPage') }}"
                                                class="rts-btn btn-primary-3 transparent">About Us</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
