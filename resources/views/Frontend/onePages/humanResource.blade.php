...
@section('content')
<body class="index-seven hr onepage">
    <!-- start header area -->
    <!-- start header area -->
    ...
    <div class="rts-banner-area banner-human-bg rts-section-gap" id="banner">
        <div class="shape">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="banner-inner-six">
                        ...
                        <a href="#" class="rts-btn btn-primary-5 rounded-2">Let’s Work Together</a>
                    </div>
    ...
    <div class="rts-service-area home-seven rts-section-gap" id="service">
    ...
    <!-- team area start -->
    <div class="rts-team-area-style-six rts-section-gap" id="team">
