...
@section('meta_description')
    Châssis PVC à Hannut et Waremme : isolation thermique performante, excellent rapport qualité-prix et entretien minimal. Installation et remplacement par Manu Potvin.
@endsection
                                    ...
                                    <div class="row g-5 align-items-center">
                                        ...
                                        <div class="col-lg-6 col-md-6 mx-auto text-center">
                                            ...
                                            <div class="thumbnail details">
                                                <img src="{{ asset('assets/images/custom/default/chassis/chassis_detail_alu.jpeg') }}" alt="finbiz_buseness" class="img-fluid" loading="lazy">
                                            </div>
                                        </div>
